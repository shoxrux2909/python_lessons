# my_list = ['ali','Vali','Ali','oysha','vali']
# my_dict = {}
# for ism in my_list:
#     my_dict[ism] = my_list.count(ism and ism.lower() and ism)
# print(my_dict)

# grade_dict = {}
# n = 0
# while n<3:
#     fan_nomi = input(f"{n+1}-fan nomini kiriting: ")
#     grade_dict[fan_nomi] = float(input(f"{fan_nomi.title()} bo'yicha olingan baho: "))
#     n += 1 
# grade_dict["o'rtacha ball"] = sum(grade_dict.values())/len(grade_dict)
# print(grade_dict)
